...
describe('Rule Engine', () => {
  ...
  it('does not execute the after function if conditions are not met', async () => {
    const rule = {
      before: { func: 'beforeFunction' },
      conditions: {
        and: [{ fact: 'factValue', operator: Operator.LESS_THAN, value: 10 }],
      },
      after: { func: 'afterFunction' },
    };
    ruleEngine.addRule(rule);
  ...
  it('handles logical OR conditions correctly', async () => {
    const rule = {
      ...
      conditions: {
        or: [
          { fact: 'factValue', operator: Operator.STRICT_EQUAL, value: 5 },
          { fact: 'factValue', operator: Operator.GREATER_THAN, value: 5 },
        ],
      },
      after: { func: 'afterFunction' },
    };
  ...
  it('handles strict equal operator correctly', async () => {
    const rule = {
      ...
      conditions: {
        and: [
          { fact: 'factValue', operator: Operator.STRICT_EQUAL, value: 10 },
        ],
      },
      after: { func: 'afterFunction' },
    };
  ...
  it('handles strict not equal operator correctly', async () => {
    const rule = {
      ...
      conditions: {
        and: [
          { fact: 'factValue', operator: Operator.STRICT_NOT_EQUAL, value: 20 },
        ],
      },
      after: { func: 'afterFunction' },
    };
  ...
  it('handles loose equal operator correctly', async () => {
    const rule = {
      ...
      conditions: {
        and: [
          { fact: 'factValue', operator: Operator.LOOSE_EQUAL, value: '10' },
        ],
      },
      after: { func: 'afterFunction' },
    };
  ...
  it('handles greater than operator correctly', async () => {
    const rule = {
      before: { func: 'beforeFunction' },
      conditions: {
        and: [{ fact: 'factValue', operator: Operator.GREATER_THAN, value: 5 }],
      },
      after: { func: 'afterFunction' },
    };
    ruleEngine.addRule(rule);
  ...
  it('handles less than operator correctly', async () => {
    const rule = {
      before: { func: 'beforeFunction' },
      conditions: {
        and: [{ fact: 'factValue', operator: Operator.LESS_THAN, value: 20 }],
      },
      after: { func: 'afterFunction' },
    };
    ruleEngine.addRule(rule);
  ...
  it('handles contains operator correctly', async () => {
    const rule = {
      before: { func: 'beforeFunction' },
      conditions: {
        and: [{ fact: 'array', operator: Operator.CONTAINS, value: 'fact' }],
      },
      after: { func: 'afterFunction' },
    };
    ruleEngine.addRule(rule);
  ...
  it('handles not contains operator correctly', async () => {
    const rule = {
      before: { func: 'beforeFunction' },
      conditions: {
        and: [{ fact: 'array', operator: Operator.NOT_CONTAINS, value: 'XYZ' }],
      },
      after: { func: 'afterFunction' },
    };
    ruleEngine.addRule(rule);
  ...
  it('handles starts with operator correctly', async () => {
    const rule = {
      before: { func: 'beforeFunction' },
      conditions: {
        and: [{ fact: 'message', operator: Operator.STARTS_WITH, value: 'H' }],
      },
      after: { func: 'afterFunction' },
    };
    ruleEngine.addRule(rule);
  ...
  it('handles ends with operator correctly', async () => {
    const rule = {
      before: { func: 'beforeFunction' },
      conditions: {
        and: [{ fact: 'message', operator: Operator.ENDS_WITH, value: 'o' }],
      },
      after: { func: 'afterFunction' },
    };
    ruleEngine.addRule(rule);
  ...
  it('reports error when the before function is not found', async () => {
    ...
    expect(errorResult.reason).toBe(
      "An error occurred: Function 'nonExistentFunction' not found or not a function.",
    );
  });
